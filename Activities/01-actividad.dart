  ...
  var datos = [];
   ...
   while (continuar) {
    ...
    int edad = int.parse(stdin.readLineSync().toString());
      ...
      switch (estado) {
        case "1": { estado = 'Soltero';}
          break;
        case "2": { estado = 'Casado';}
          break;
        case "3": { estado = 'Viudo';}
          break;
      }
      ...
      switch (menu) {
        case '1': {
          ...
          dynamic porcentajeHombresSolteros = contadorHombresSolteros * 100 / contadorHombres;
          print('el porcentaje de hombres solteros es: $porcentajeHombresSolteros');
        ...
        case '2': {
          ...
          int sum = 0;
            ...
            if (genero == 'Hombre' && estadoCivil == 'Casado') {
              edadesHombresCasados.add(element['edad']);
            }


       
        }
            for (var i = 0; i < edadesHombresCasados.length; i++) {
              sum += i;
            }

            var promedioEdades = sum / edadesHombresCasados.length;
            print('El promedio de edad de los hombres casados es: $promedioEdades');
        ...
        case '3': {
              ...
              dynamic porcentajeMujeresSolteras = contadorMujeresSolteras * 100 / contadorMujeres;
              print('El porcentaje de mujeres solteras es: $porcentajeMujeresSolteras');
